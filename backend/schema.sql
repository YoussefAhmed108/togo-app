...
DROP TABLE IF EXISTS eta_static;
DROP TABLE IF EXISTS eta_traffic;
...
-- ----------------------------------------------------------
-- Estimated travel time (migration 016)
-- A list shows the no-traffic drive time (kept 30 days) times a traffic
-- factor learned per ~5 km area and hour of the week from live readings.
-- ----------------------------------------------------------
